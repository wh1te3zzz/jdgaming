...
All变量适用
————————————————
入口：[ 1.17～2.15 品质女装 年终狂欢 (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=67ba2ad44b8041c9925bf0e72febbdb2&shareUuid=bc23f507f8da4377b20016aa298eb537)]

请求太频繁会被黑ip
过10分钟再执行

cron:55 3 1-15/3,17-31/3 1,2 *
============Quantumultx===============
[task_local]
#1.17～2.15 品质女装 年终狂欢
55 3 1-15/3,17-31/3 1,2 * https://github.com/wh1te3zzz/jdgaming/blob/main/jd_active_OpenCard30.js, tag=1.17～2.15 品质女装 年终狂欢, enabled=true
...
!(async () => {
  ...
  $.shareUuid = "bc23f507f8da4377b20016aa298eb537"
