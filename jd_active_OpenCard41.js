...
[task_local]
#个护女神节
35 2 * * * jd_active_OpenCard41.js, tag=个护女神节, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "35 2 * * *" script-path=jd_active_OpenCard41.js,tag=个护女神节

===============Surge=================
个护女神节 = type=cron,cronexp="35 2 * * *",wake-system=1,timeout=3600,script-path=jd_active_OpenCard41.js

============小火箭=========
个护女神节 = type=cron,script-path=jd_active_OpenCard41.js, cronexpr="35 2 * * *", timeout=3600, enable=true
