...
第一个CK失效会退出脚本
————————————————
入口：[ 2.24~3.4 常青藤联合开卡 (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dzb1830e004adfb1f0b05a83bf6ac7&shareUuid=)]

请求太频繁会被黑ip
过10分钟再执行

cron:25 0 27-28,1-4 2,3 *
============Quantumultx===============
[task_local]
#2.24~3.4 常青藤联合开卡
25 0 27-28,1-4 2,3 * jd_active_OpenCard39.js, tag=2.24~3.4 常青藤联合开卡, enabled=true
...
!(async () => {
  ...
  $.shareUuid = ['b4d4177c7fda4330b31433ccfb347cfb']
