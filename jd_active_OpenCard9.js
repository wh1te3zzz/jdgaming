...
2.开11张 成功开1张 可能获得5京豆
  全部开完获得1次抽奖
3.关注10京豆 获得1次抽奖
4.加购5京豆 获得1次抽奖(默认不加购 如需加购请设置环境变量[opencard_addSku9]为"true"
...
[task_local]
#12.20～12.26 联合开卡
30 9 24,25,26 12 * https://github.com/wh1te3zzz/jdgaming/blob/main/jd_active_OpenCard9.js, tag=12.20～12.26 联合开卡, enabled=true
...
const $ = new Env('12.20～12.26 联合开卡-9');
...
!(async () => {
  ...
  $.MixNicks = ''
  $.inviteNick = 'h4k5Qxjrz7QBS4kyc+JXKe2eeeAAy+Z4dS9uCTK4WDbpzoLrW7NWpeN+ekvNaPF4'
